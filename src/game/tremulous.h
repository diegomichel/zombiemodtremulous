...
#define MGTURRET_RANGE              200.0f
#define MGTURRET_SPREAD             200
#define MGTURRET_DMG                HDM(12)
#define MGTURRET_DCC_ANGULARSPEED       100
#define MGTURRET_DCC_ACCURACYTOLERANCE  MGTURRET_DCC_ANGULARSPEED / 1.5f
#define MGTURRET_GRAB_ANGULARSPEED      30
...
#define ALIEN_MAX_KILLS             2000
#define ALIEN_MAX_SINGLE_KILLS      900

#define FREEKILL_PERIOD             40000 //msec
#define FREEKILL_ALIEN              LEVEL0_VALUE
