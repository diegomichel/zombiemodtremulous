...
void CheckExitRules( void )
{
        ...
        ( level.numLiveAlienClients == 0 ) ) )
  {
    ...
    trap_SendServerCommand( -1, "print \"The Federations have captured all the telenodes!\n\"");
             ...
             ( level.numLiveHumanClients == 0 ) ) )
  {
    ...
    trap_SendServerCommand( -1, "print \"The Rebels have captured all the telenodes!\n\"");
