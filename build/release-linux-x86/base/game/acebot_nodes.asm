...
proc ACEND_FindCloseReachableNode 100 28
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
RETI4
LABELV $96
endproc ACEND_FindCloseReachableNode 100 28
export ACEND_FindClosestReachableNode
proc ACEND_FindClosestReachableNode 152 28
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
RETI4
LABELV $114
endproc ACEND_FindClosestReachableNode 152 28
export ACEND_SetGoal
proc ACEND_SetGoal 24 12
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $146
LABELV $139
endproc ACEND_SetGoal 24 12
export ACEND_FollowPath
proc ACEND_FollowPath 36 12
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
RETI4
LABELV $149
endproc ACEND_FollowPath 36 12
...
pop
LABELV $246
endproc ACEND_ShowNode 12 4
export ACEND_DrawPath
proc ACEND_DrawPath 20 4
ADDRFP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
proc ACEND_UpdateNodeEdge 60 12
ADDRFP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
LABELV $359
LABELV $337
endproc ACEND_UpdateNodeEdge 60 12
export ACEND_RemoveNodeEdge
proc ACEND_RemoveNodeEdge 12 16
ADDRFP4 4
ADDRFP4 4
INDIRI4
ASGNI4
...
LTI4 $368
LABELV $363
endproc ACEND_RemoveNodeEdge 12 16
...
proc ACEND_selectNextNode 12 0
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNI4
LABELV $436
endproc ACEND_selectNextNode 12 0
bss
export path_table
align 2
LABELV path_table
